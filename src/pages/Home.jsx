    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .nav-inner { padding: 16px 20px !important; margin-bottom: 2rem !important; }
          .container-inner { padding: 1rem 1.25rem !important; }
          .trust-badges { flex-wrap: wrap !important; gap: 0.75rem !important; }
      ...
      <div style={styles.page}>
        ...
        <div style={styles.container} className="container-inner">

          {/* Nav */}
          <div style={styles.nav} className="nav-inner">
          ...
          <div className="reveal steps-row" style={styles.stepsRow}>
            {[
          ...
          <div className="reveal features-grid" style={styles.featuresGrid}>
          ...
          <div className="reveal" style={styles.cta}>
            <h2 style={styles.ctaTitle} className="cta-title">Ready to start?</h2>
...
const styles = {
  page: { minHeight: "100vh", background: "#060c18", color: "#e2e8f0", position: "relative", overflowX: "hidden" },
  glowBlob: { position: "fixed", top: "-120px", left: "50%", transform: "translateX(-50%)", width: "800px", height: "600px", background: "radial-gradient(ellipse, rgba(59,130,246,0.13) 0%, transparent 70%)", pointerEvents: "none", zIndex: 0 },
  container: { maxWidth: "1100px", margin: "0 auto", padding: "2rem 3rem", position: "relative", zIndex: 1 },
  nav: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "5rem", paddingTop: "0.5rem", borderBottom: "1px solid #0d1f38", paddingBottom: "1.25rem" },
  ...
  eyebrowPill: { display: "inline-block", fontSize: "11px", color: "#3b82f6", letterSpacing: "0.06em", background: "rgba(59,130,246,0.1)", border: "1px solid rgba(59,130,246,0.2)", borderRadius: "20px", padding: "4px 14px", marginBottom: "1.5rem", fontWeight: "500" },
  heroTitle: { fontSize: "58px", fontWeight: "700", lineHeight: "1.1", letterSpacing: "-0.03em", margin: "0 0 1.5rem", color: "#ffffff" },
  heroBlue: { color: "#3b82f6" },
  heroSubtitle: { fontSize: "16px", color: "#64748b", lineHeight: "1.7", maxWidth: "520px", margin: "0 0 1.5rem" },
  ...
  btnPrimary: { padding: "11px 26px", fontSize: "14px", fontWeight: "600", background: "#3b82f6", color: "#ffffff", border: "none", borderRadius: "8px", cursor: "pointer", transition: "background 0.2s, transform 0.15s, box-shadow 0.2s" },
  btnSecondary: { padding: "11px 26px", fontSize: "14px", fontWeight: "500", background: "transparent", color: "#94a3b8", border: "1px solid #1e3a5f", borderRadius: "8px", cursor: "pointer", transition: "color 0.2s, border-color 0.2s, background 0.2s" },
  ...
  stepCard: { background: "#0a1628", border: "1px solid #0d1f38", borderRadius: "12px", padding: "1.5rem" },
  stepHeader: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1rem" },
  stepIconWrap: { width: "36px", height: "36px", background: "rgba(59,130,246,0.1)", border: "1px solid rgba(59,130,246,0.15)", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", color: "#3b82f6" },
  stepNum: { fontSize: "11px", fontWeight: "700", color: "#1e3a5f", letterSpacing: "0.08em" },
  ...
  featureIconWrap: { width: "36px", height: "36px", background: "rgba(59,130,246,0.08)", border: "1px solid rgba(59,130,246,0.12)", borderRadius: "8px", display: "flex", alignItems: "center", justifyContent: "center", color: "#3b82f6", marginBottom: "0.5rem" },
